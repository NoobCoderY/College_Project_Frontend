...
export default function Products({ width }) {
  ...
  const [prevsort, setPrevsort] = useState("date");
  ...
  useEffect(() => {
    if (user?.userName) {
      axios
        .get(
          `${API_HOST}/userProducts/adminViews?pageSize=9&pageNumber=${page}${
  ...
  useEffect(() => {
    if (user?.userName) {
      axios
        .get(
          `${API_HOST}/websites/viewWebsite?pageSize=1000&pageNumber=1}
        `,
          {
            headers: {
              Authorization:
        ...
        .then((res) => {
          setwebsites(res.data?.success?.data);
        });
    }
  }, [user]);
              ...
              <Box sx={width > 700 ? style : style1}>
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <input
                      onClick={() => setPrevsort("date")}
                      type="checkbox"
                      name=""
                      id=""
                      style={{ margin: "0 1vw" }}
                      checked={prevsort === "date" ? true : false}
                    />
                    <span className="jobpodtedfieldtitile">Date (Recent)</span>
                  </div>
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <input
                      onClick={() => setPrevsort("productName")}
                      type="checkbox"
                      name=""
                      id=""
                      style={{ margin: "0 1vw" }}
                      checked={prevsort === "productName" ? true : false}
                    />
                    <span className="jobpodtedfieldtitile">Alphabet</span>
                  </div>
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <input
                      onClick={() => setPrevsort("shortBycost")}
                      type="checkbox"
                      name=""
                      id=""
                      style={{ margin: "0 1vw" }}
                      checked={prevsort === "shortBycost" ? true : false}
                    />
                    <span className="jobpodtedfieldtitile">Cost Price</span>
                  </div>
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <input
                      onClick={() => setPrevsort("visiblity")}
                      type="checkbox"
                      name=""
                      id=""
                      style={{ margin: "0 1vw" }}
                      checked={prevsort === "visiblity" ? true : false}
                    />
