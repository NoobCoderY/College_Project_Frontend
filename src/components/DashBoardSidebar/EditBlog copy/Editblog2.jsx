...
import AddTableofContent1 from "./AddTableofContent";
...
export default function Editblog2({ width }) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        setArrayofblogs(res?.data?.success?.data[0]?.toC[0]);
        setAge3(
  ...
  return (
    <div style={{ height: "calc(100vh - 4vw)" }} className="ScrollTable">
      ...
      >
        ...
        >
          <div className="jobpostedformheading">Edit Blogs (By Team)</div>
          ...
          <div>
            ...
            {data && arrayofblogs && allCbutton && allCtitle && (
              <AddTableofContent1
