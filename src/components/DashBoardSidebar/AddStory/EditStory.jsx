...
export default function EditStory() {
  ...
  const handlecategory = () => {
    ...
    axios
      .post(`${API_HOST}/stories/editStory`, formdata, {
        headers: {
  ...
  const [iamge1, setIamge1] = useState();
  ...
  useEffect(() => {
    axios.get(`${API_HOST}/stories/viaId?storyId=${id}`).then((res) => {
      setName(res?.data?.success?.data?.heading);
      setAns(res?.data?.success?.data?.content);
      setIamge1(res?.data?.success?.data?.image);
    });
  }, [id]);
  ...
  return (
    <div style={{ height: "calc(100vh - 4vw)" }} className="ScrollTable">
      ...
      >
        ...
        >
          <div className="jobpostedformheading">Edit Story </div>
          ...
          <div>
            ...
            >
              ...
              <div className="inputfilesshowncatboxsingle">
                ...
                <div className="fileselctednamecate">
                  {iamge ? iamge?.name.slice(0, 50) : iamge1}
                </div>
              </div>
            ...
            >
              <div
                ...
                onClick={() => navigate("/dashbaord/story")}
              >
                Cancel
              </div>
