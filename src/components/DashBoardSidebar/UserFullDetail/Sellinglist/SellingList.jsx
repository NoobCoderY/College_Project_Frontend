...
export default function SellingList({ width, user }) {
  ...
  useEffect(() => {
    if (user?.userName) {
      axios
        .get(
          `${API_HOST}/carts/viewSellerViaAdmin?pageSize=11&userName=${
            user?.userName
          }&pageNumber=${page}${`&search=${setSelectedCategory}`}${
    ...
    >
      ...
      >
        <div className="serachjobbox">
          ...
          <input
            type="text"
            placeholder={"search  Yours Orders"}
            ...
            >
              <Box sx={width > 700 ? style : style1}>
                ...
                >
                  ...
                  <div className="jobpodtedfieldtitile">Buying Price </div>
                  ...
                  <div className="jobpodtedfieldtitile">Search Address </div>
      ...
      >
        ...
        >
          <div style={{ width: width > 700 ? "14vw" : "30vw" }}>Website</div>
